...
- **Three context-engineering layers**: unfiltered context, then relevance filtering (inverted index + vector search), then importance scoring with time decay
...
- **Headline result**: a quality-vs-cost frontier across context strategies
